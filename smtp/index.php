...
$html=" <h2 style='color:Red'><center>Reset your Vkonex-Connectin password</center></h2><br><br>


Vkonex-Connectin password reset<br><br>

We heard that you lost your Vkonex-Connectin password. Sorry about that!

But don’t worry! <br>You can use the following OTP to reset your password: <br>
...
To get a new password reset link, visit: http://65.0.131.51/password/forgot_password.php?id=$otp_id
...
$subject="[Vkonex-Connectin] Please Reset Your Password";
...
header("location: http://65.0.131.51/password/forgot_password.php?id=$otp_id");
