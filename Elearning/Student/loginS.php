            ...
            <form method="POST" action="loginS.php"> 
                <center>
                    <div class="main ">
                      ...
                      <!--  <p>Don't Have account ?<a href="signupS.php"><span class="text">Create Account</span><a></p>
                        <p></p>-->
                        <?php
                include('../error.php');
                ?>
                       <!-- <div class="form-group mt-5">
                        ...
                        <div class="form-group form-check ">
                            <a href="../password/forgot_password.php"><label class="form-check-label" for="exampleCheck1"><a href="../../password/reset.php"><span class="text">Forgot Password ?</span></a></label></a>
                        </div>
