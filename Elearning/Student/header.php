            ...
            <div class="collapse navbar-collapse scroll" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <i class="fas fa-book"></i>
                        <div class="dropdown">
                            <a class="dropbtn .dar" href="manage-cource.php" style="text-decoration: none;"><span style="font-weight: bold;">My Cource</span></a>
                        </div>
                    </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <i class="fas fa-text-height"></i>
                        <div class="dropdown">
                            <a class="dropbtn .dar" href="assignment.php" style="text-decoration: none;"><span style="font-weight: bold;">My Assignment</span></a>
                    </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <i class="fas fa-list"></i>
                        <div class="dropdown">
                            <a class="dropbtn .dar" href="invite.php" style="text-decoration: none;"><span style="font-weight: bold;">My invite</span></a>
                    </li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
