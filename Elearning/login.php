        ...
        <div class="col-xl-6 col-md-6 forms">
            <form method="POST"> 
                <center>
                    <div class="main ">
                        <h3>Admin Sign In</h3>
                        <p>Don't Have account ?<a href="signup.php"><span class="text">Create Account</span><a></p>
                        <p></p>
                        <?php
                include('error.php');
                ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="Loginpassword" class="form-control input-sm" id="exampleInputPassword1"
                                placeholder="Password">
                        </div>
                        <div class="form-group form-check ">
                            <a href="#"><label class="form-check-label" for="exampleCheck1"><a href="forgot.php"><span class="text">Forgot Password ?</span></a></label></a>
                        </div>
                        <button type="submit" name="login" class="btn btn-lg">Submit</button>
            </form>
        </div>
        </center>
        </div>
