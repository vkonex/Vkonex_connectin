...
?>
        ...
        <div class="row">
            <div class="container">
                <div class="col-md-6 col-sm-6 col-xl-6 " style="margin-top:10rem;">
                    ...
                    <h1> Market your eLearning Business -One platform to Promote and Sell Online Courses</h1>
                    <h3>Apart from being loaded with all essential and trending marketing tools out of the box, Pinlearn
                        effortlessly supports integration with all popular third-party APIs or tools.</h3>
                    <a href="#feature" class="section-btn btn btn-default smoothScroll ">Live Demo</a> &nbsp;
                    &nbsp; &nbsp; &nbsp;
                    <a href="#feature" class="section-btn btn btn-default smoothScroll ">Pricing</a>
                </div>
        ...
        <div class="container">
            <div class="row" ">
                ...
                <div class="section-title">
                    ...
                    <h2>Best eLearning Integrations</h2>
                    <h3>No ready-made software is effective if it can’t communicate with popular<br>
                        integrations on the market. We have got the integrations of major APIs covered.</h3>
                </div>
            </div>
        </div>
    ...
    <section id="img" class="text-center">
        ...
        <h4>Get Pinlearn to manage your marketing and promotions in the best ways possible. Open the new horizons with integrated<br> marketing tools. notification APIs etc. covered for you.</h4>
