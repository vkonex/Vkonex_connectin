...
if(isset($_POST['submit']))
{
  ...
  $category =mysqli_real_escape_string($db,$_POST['category']);
      ...
      $user_check="SELECT * FROM create_subject  WHERE name='$name' OR category='$category' LIMIT 1";
      ...
      if((count($error) == 0) )
      {
        ...
        $query=" INSERT INTO  create_subject  (name,alias,category) VALUES ('$name','$alias', '$category')";
        mysqli_query($db,$query);
        header('location:dashboard_filter_subject_listsubject.php');
      }
...
<body style="background-color:#dfe6e9" >
  <h3 style="color:#398bf7" class="ms-5"> Create New Subject</h3>
      ...
      <div class="col-md-11 col-xl-11 col-11 ms-md-5 " style="background-color: #fff;height: 400px;">
        <form class="row g-3  mt-3  " method="POST">
          ...
          <div class="col-md-6">
            ...
            <select id="role" name="role" class="form-select" name="category">
