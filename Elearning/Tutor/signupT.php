...
if(isset($_POST['submit']))
{
    ...
    // input from form
        ...
        $user_check="SELECT * FROM tutor WHERE name='$name' OR email='$email' LIMIT 1";
        ...
        if((count($error) == 0) )
        {
            ...
            $query=" INSERT INTO tutor (name,email,password) VALUES('$name','$email','$encrypt_pswd')";
        ...
        <div class="col-xl-6 col-md-6 forms">
            <form method="POST"> 
                ...
                <center>
                    <div class="main ">
                        <h3>Tutor Sign Up</h3>
                        <p>Already Have account ?<a href="loginT.php"><span class="text">Login</span><a></p>
                        <p></p>
                        <?php
                include('../error.php');
                ?>
