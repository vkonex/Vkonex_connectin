...
<datalist id="browsers">
  ...
  <option value="Microsoft Edge">
    ...
    <div class="col">
    <div class="dropdown">
  <Button style="width:140px; height:38px;" class="form-control dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"></Button>
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    ...
    <div class="col" style="margin-right:160px">
    <div class="dropdown">
  <button style="width:140px; height:38px;" class="form-control dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"></button>
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><a class="dropdown-item" href="#">All</a></li>
...
<div class="container">
  ...
  <div class="col-md-2">
    ...
    <a href="studentreport.php" style="background:black; color:#fff; text-decoration:none; padding:4px; border-radius:4px;">Visit</a>
    </div>
