...
<head>
    ...
    <title>My Profile | Geoconnectin</title>
    <meta name="description" content="Geoconnectin">
    <meta name="csrf-token" content="t0QbkGej6dLNpjxvwseIO6NHgO2WNxyzE7oYW5aC">

    <!-- Tell the browser to be responsive to screen width -->
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, shrink-to-fit=no">
    <link href="http://52.66.188.103/themes/geoconnectin/images/favicon.icon" rel='shortcut icon'>
    
    
    

    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.min.css">
    <link rel="stylesheet" href="http://52.66.188.103/themes/geoconnectin/assets/css/font-awesome.min.css">
    ...
    <!-- jQuery 3 -->
    <script src="http://52.66.188.103/themes/adminlte/bower_components/jquery/dist/jquery.min.js"></script>
    <script type="text/javascript">
        var BASE_URL = 'http://52.66.188.103/';
        $.ajaxSetup({
            headers: {
                      ...
                      <ul class="float-right list-inline d-flex mb-0">
                        <li class="nav-item list-inline-item nav-user hide-on-mobile ml-auto mr-0">
                          <a aria-current="page" class="active prof avt_ico" test-id="user-menu-link-to-my-profile" >
                            <div class="jss41">
                              <div class="jss42">
                                <div class="jss43 jss46 uper">Vkonex AI </div>
                      ...
                      <ul class="nav-menu side-nav__menu">
                        ...
                        <div class="jss246 jss245">
                            <div class="jss247 chat-list-custom">
                                ...
                                <button class="MuiButtonBase-root btn jss248" id="FrinRequest" type="button">Requests</button><div class="text-truncate text-secondary font-weight-bold lstcnt"></div>
                            </div>
                        </div>
...
<div class="slider profile__edit_wrap" id="profile-middle">
          ...
          <div class="tinder--cards">
            <div class="tinder--card profile-intro" style="z-index: 1; transform: scale(1) translateY(0px); opacity: 1; touch-action: pan-y; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
                <div class="head_image">
                                        <!-- <div class="overlay" style="background-image: url('http://52.66.188.103/assets/images/default-user.jpg'); background-position: center center; background-size: cover; background-repeat: no-repeat;"></div> -->
                    <div class="card-image">
                        <div>
                          <label for="inputFileAvatar" class="profPicWrap select__item_op">
                            ...
                            <img src="http://52.66.188.103/assets/images/default-user.jpg" class="user-avatar modal__avatar size-110 pointer">
                            <div class="avatar__edit">
                              <h6 class="avataredit "><i class="fa fa-pencil av_edit"></i></h6>
                        ...
                        <div class="user-detail">
                          <div class="user_name_wrap select__item_op select__item_op">
                              ...
                              <div class="user_edit_rmv_icon">
                                <h6 class="useredit "><i class="fa fa-pencil av_edit"></i></h6>
                          ...
                          <div class="user_disc_wrap select__item_op">
                            <p class="editdescription user-description settings__icon-edit icon--white">
                                                        <span>Share your company and designation</span>
                                                        </p>
                            <div class="user__desc">
                              <h6 class="descedit"><i class="fa fa-pencil av_edit"></i></h6>
                ...
                <div class="head_detail_wrap">
                    <div class="edit__fldtag profile-content profile-interest settings__icon-edit select__item_op" id="tag">
                                                ...
                                                <div class="user__tag">
                            <h6 class="tagedit"><i class="fa fa-pencil av_edit"></i></h6>
                    ...
                    <div class="profile-content goal_wrap select__item_op">
                      ...
                      <div class="goals">
                                                  <div class="user__tag">
                            <h6 class="goaledit"><i class="fa fa-pencil av_edit"></i></h6>
                    ...
                    <div class="profile-content bio_wrap select__item_op">
                      <div class="bio settings__icon--center">
                        <div class="card-text">
                          ...
                          <p style="word-break: break-word;"><span class="Linkify">Share more about your goals & how you can help others!</span>
                                                </div>
                      <div class="user__bio">
                   ...
                   <div class="profile-content profile-details">
                      <div class="experience settings__icon--wrap">
                        <button class="MuiButtonBase-root jss162" tabindex="0" type="button">
                            <svg width="1em" height="1em" viewBox="0 0 16 15" class="jss164" style="fill: #850d71">
                    ...
                    <div class="profile-content profile-details">
                      <div class="industry settings__icon--wrap">
                        <button class="MuiButtonBase-root jss162" tabindex="0" type="button">
                          <svg width="1em" height="1em" viewBox="0 0 32 32" class="jss164" style="fill: #850d71">
                          ...
                          <div class="jss167">
                              ...
                              <span id="industry_profile_data">What is your industry?</span>
                          </div>
                        </button>
                   ...
                   <!-- <div class="profile-content profile-details">
                    ...
                    <div class="profile-content profile-details"> 
                      <!-- <div class="social__media-wrap settings__icon--wrap select__item_op" id="linkdclass">
                        ...
                        <div class="user__previous">
                            <h6 class="linkededit"><i class="fa fa-pencil av_edit"></i></h6>
                      ...
                      <div class="social__media-wrap settings__icon--wrap select__item_op" id="webclass">
                        ...
                        <div class="user__previous">
                            <h6 class="websiteedit"><i class="fa fa-pencil av_edit"></i></h6>
                      ...
                      <!-- <div class="social__media-wrap settings__icon--wrap select__item_op">
                        ...
                        <div class="user__previous">
                            <h6 class="twitteredit"><i class="fa fa-pencil av_edit"></i></h6>
                      ...
                      <div class="social__media-wrap settings__icon--wrap select__item_op">
                        ...
                        <div class="user__previous">
                            <h6 class="instagramedit"><i class="fa fa-pencil av_edit"></i></h6>
    ...
    <div class="right_panel" id="mobile-set">
      <div class="jss37 my_skills">
          ...
          <div id="interests" style="display: none;">
            ...
            <form class="jss1332" name="my_interests_frm">
              <h2 class="MuiTypography-root jss1335 MuiTypography-h2"><span>My interests</span></h2>
              <div id="my_interest_message" class="sbmt__msg"></div>
              <div class="settings__item">
                <input type="text" id="serchtag" class="form-control form-control-lg" value="">
                <button type="button" disabled="" class="settings__input-btn btn btn-outline-secondary disabled">
                </button>
              </div>

              <div class="datac settings__item settings__item settings__item--wrap"></div>
              
              <div class="settings__item settings__item settings__item--wrap" id="my_interets_added_tags">
                                                                                </div>

              <div class="settings__meta ">
                <input type="hidden" name="my_interests" value=""/>
                <input type="hidden" name="my_interests_removed_tags" value=""/>
                <p class="settings__meta-item"><span id="my_interests_count">0</span>/12</p>
              </div>

              <div class="jss1337 profile__btn_wrap">
                <button class="MuiButtonBase-root btn jss1338 jss1348 jss1339" id="intrestcancel" tabindex="0" type="button" test-id="back" color="secondary" variant="contained"><span>Cancel</span></button>
                <button id="conform" class="MuiButtonBase-root btn jss1338 jss1342 jss1339" tabindex="0" type="submit" color="primary" variant="contained"><span>Confirm</span></button>
              </div>
            </form>
          </div>
          ...
          <div id="bio" style="display: none;">
            ...
            <form name="frm_my_bio" class="jss264">
                ...
                <div class="jss271">
                  <div class="jss272 profile__wrap">
                    <div class="jss277 profile__edt profile_mybio">
                      <textarea id="about_me" cols="4" rows="4" name="about_me" class="jss281" style="height: 150px;overflow: hidden;"onKeyDown="limitText(this.form.about_me,this.form.countdown,250);" onKeyUp="limitText(this.form.about_me,this.form.countdown,250);"></textarea>
                    </div>
                  </div>
          ...
          <div id="experience" style="display: none;">
            ...
            <form name="frm_my_experience" class="jss264">
              ...
              <div class="jss542">
                ...
                <input type="checkbox" name="is_student" id="is_student" value="0"  />
          ...
          <div id="education" style="display: none;">
            <div class="jss105">
              ...
              <div class="jss821">
                ...
                <button class="MuiButtonBase-root jss822" tabindex="0" type="button" id='btn_add_education'>
                    <svg width="1em" height="1em" viewBox="0 0 32 32">
                        <path
                            d="M30.8 14.8H17.2V1.2A1.2 1.2 0 0 0 16 0a1.217 1.217 0 0 0-1.2 1.199V14.8H1.2A1.217 1.217 0 0 0 0 15.999V16a1.2 1.2 0 0 0 1.2 1.2h13.6v13.6A1.2 1.2 0 0 0 16 32h.016c.654 0 1.184-.53 1.184-1.184v-.017.001-13.6h13.616c.654 0 1.184-.53 1.184-1.184v-.017V16a1.2 1.2 0 0 0-1.2-1.2z"
                        ></path>
                    </svg>
                </button>
              </div>
              ...
              <!-- Add Education -->
              <form id="frm_add_education" name="frm_add_education" style="display: none;">
                    ...
                    <div class="jss271">
                      <div class="jss272 profile__wrap">
                        <div class="jss277 profile__edt">
                          <input class="jss281" type="text" id="frm_add_education_school" name="frm_add_education_school" name="" test-id="input-undefined" value="">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="jss269 jss264">
                    ...
                    <div class="jss271">
                      <div class="jss272 profile__wrap">
                        <div class="jss277 profile__edt">
                          <input class="jss281" type="text" id="frm_add_education_degree"  name="frm_add_education_degree" name=""test-id="input-undefined" value="">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="jss823">
                <div class="jss824">
                    ...
                    <button class="MuiButtonBase-root jss833" tabindex="0" type="button">
                        <svg width="1em" height="1em" viewBox="0 0 32 32">
                            <path
                                d="M31.632.368a1.247 1.247 0 0 0-1.76 0L16 14.24 2.128.368a1.247 1.247 0 0 0-1.76 0 1.23 1.23 0 0 0 0 1.744L14.24 16 .368 29.872a1.247 1.247 0 0 0 0 1.76 1.247 1.247 0 0 0 1.76 0L16 17.744l13.872 13.888a1.247 1.247 0 0 0 1.76 0 1.247 1.247 0 0 0 0-1.76L17.76 16 31.632 2.112a1.23 1.23 0 0 0 0-1.744z"
                            ></path>
                        </svg>
                    </button>
                </div>
          ...
          <div id="industry" style="display: none;">
            ...
            <form name="frm_my_industry" class="">
              ...
              <div class="settings__wrapper jss264 pt-0 mb-0">
                  <input type="text" class="form-control form-control-lg" placeholder="Search industry" required="" value="" id="search_industry_input" onkeyup="searchIndustry()">
          ...
          <div id="goal" style="display: none;">
            ...
            <form name="frm_my_goal" class="jss264">
              ...
              <div class="jss269">
                <div class="settings__item__block">
                        ...
                        <div class="settings__goals">
                                        ...
                                        <div class="settings__goals-wrapper">
                        <i class="fa fa-pencil-square-o icon-geo" aria-hidden="true"></i>
                        <div class="settings__goals">
          ...
          <div id="identity" style="display: none;">
              ...
              <form name="frm_my_identity" class="jss264">
                ...
                <div class="jss269">
                  ...
                  <div class="jss271">
                    <div class="jss272 profile__wrap">
                      <div class="jss277 profile__edt">
                        <input class="jss281" type="text" id="full_name" name="full_name" test-id="input-undefined" value="Vkonex AI">
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div id="changeDescription" style="display: none;">
              ...
              <form name="frm_chngdes" class="jss264">
                <h2 class="MuiTypography-root jss267 MuiTypography-h2"><span>My Description</span></h2>
                <div id="mydesMessage" class="sbmt__msg"></div>
                <div class="jss269">
                  <p class="MuiTypography-root jss270 MuiTypography-body1"><span>Title</span></p>
                  <div class="jss271">
                    <div class="jss272 profile__wrap">
                      <div class="jss277 profile__edt">
                        <input class="jss281" type="text" placeholder="Enter title" id="designation" name="designation" test-id="input-undefined" value="">
                      </div>
                    </div>
                  </div>
                </div>
                <div class="jss269">
                  ...
                  <div class="jss271">
                    <div class="jss272 profile__wrap">
                      <div class="jss277 profile__edt">
                        <input class="jss281" type="text" id="company" placeholder="Enter organization" name="company"test-id="input-undefined" value="">
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div id="profileImage" style="display: none;">
              ...
              <form name="frm_profileImage" class="jss264">
                  ...
                  <div class="jss1337 profile__btn_wrap">
                  <button class="MuiButtonBase-root btn jss1338 jss1348 jss1339" tabindex="0" id="cncelprofileImage" type="button" test-id="back" color="secondary" variant="contained"><span>Cancel</span>
                  </button>
                  <button class="MuiButtonBase-root btn jss1338 jss1342 jss1339" id="submittprofileImage" tabindex="0" type="submit" color="primary" variant="contained"><span>Confirm</span>
                  </button>
                  </div>
              </form>
          </div>
          ...
          <div id="changepws" style="display: none;">
              ...
              <form name="frm_chng_pws" class="jss264">
                ...
                <div class="jss269">
                  ...
                  <div class="jss271">
                    <div class="jss272 profile__wrap">
                      <div class="jss277 profile__edt">
                        <input class="jss281" type="password" minlength="8" maxlength="10" placeholder="Enter 8-10 characters" id="current_password" name="current_password" test-id="input-undefined" value="">
                ...
                <div class="jss269">
                  ...
                  <div class="jss271">
                    <div class="jss272 profile__wrap">
                      <div class="jss277 profile__edt">
                        <input id="password" type="password" class="jss281 form-control" minlength="8" maxlength="10" id="password"  placeholder="Enter new password" name="password" test-id="input-undefined">
                ...
                <div class="jss269">
                  ...
                  <div class="jss271">
                    <div class="jss272 profile__wrap">
                      <div class="jss277 profile__edt">
                        <input type="password" class="jss281 form-control" minlength="8" maxlen gth="10" 
                        name="password_confirm"  placeholder="Enter new password" id="password_confirm" test-id="input-undefined">
          ...
          <div id="emailChange" style="display:none;">
              ...
              <form name="frm_chng_email" class="jss264">
          ...
          <div id="setting">
            ...
            <ul class="settings__account-list">
                ...
                <li class="settings__account-item">
                    <div class="settings__account-switch-wrapper justify-content-between" data-checked="on">
                        ...
                        <label class="switch__pro">
                        <input type="checkbox" name="email_notification" id="email_notification" value="2" checked  />
                          <span class="slider round"></span>
                        </label>
                    </div>
                </li>
            ...
            <ul class="settings__account-list">
                ...
                <li class="settings__account-item settings__account-item--interactive">
                    <a class="settings__account-link setting-acc-color" href="/profile" target="_blank" rel="noopener noreferrer"><span>E-Learning</span><i class="icon-geo icon-geo-Forward user-summary"></i></a>
                </li>
                <li class="settings__account-item  settings__account-item--interactive">
                    <a class="settings__account-link setting-acc-color" href="/profile" target="_blank" rel="noopener noreferrer"><span>Post a job</span><i class="icon-geo icon-geo-Forward user-summary"></i></a>
                </li>
                <li class="settings__account-item  settings__account-item--interactive">
                    <a class="settings__account-link setting-acc-color" href="/profile" target="_blank" rel="noopener noreferrer"><span>My jobs</span><i class="icon-geo icon-geo-Forward user-summary"></i></a>
                </li>
            </ul>
            <ul class="settings__account-list">
                ...
                <li class="settings__account-item settings__account-item--interactive">
                    <div class="settings__account-link setting-acc-color" id="changeEmailedit"><span>Change Email Address</span><i class="icon-geo icon-geo-Edit user-summary"></i></div>
                </li>
                <li class="settings__account-item settings__account-item--interactive">
                    <div class="settings__account-link setting-acc-color" id="changepwsedit"><span>Change password</span><i class="icon-geo icon-geo-Edit user-summary"></i></div>
                </li>
            </ul>
            <ul class="settings__account-list">
                <li class="settings__account-item settings__account-item--interactive settings__account-item--no-title" onclick="event.preventDefault();document.getElementById('logout-form').submit();">
                    <div class="settings__account-link setting-acc-color" role="link" tabindex="0"><span>Log out</span><i class="icon-geo icon-geo-Forward user-summary"></i></div>
                </li>
                  <form id="logout-form" action="http://52.66.188.103/logout" method="POST" style="display: none;">
                      <input type="hidden" name="_token" value="t0QbkGej6dLNpjxvwseIO6NHgO2WNxyzE7oYW5aC">                  </form>
            </ul>
          </div>
    </div>
</div>
  ...
  <form name='razorpayform' action="http://52.66.188.103/razor/status" method="POST">
    <input type="hidden" name="_token" value="t0QbkGej6dLNpjxvwseIO6NHgO2WNxyzE7oYW5aC">
...
<script language="javascript" type="text/javascript">    
    ...
    $(document).ready(function(){
      ...
      $(document).on('click', '.new-tag', function(){
        ...
        let existsDataArr = existsData.split(',').filter(function(el) {return el.length != 0});
        ...
        let removedTagsArr = removedTags.split(',').filter(function(el) {return el.length != 0});
      ...
      $('form[name="frm_my_experience"]').validate({
        ...
        submitHandler: function(e) {
          ...
          //alert(is_student);
          $.ajax({
            url: "http://52.66.188.103/profile/date",
            method:'POST',
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            dataType: 'json',
            data: {
      ...
      $('.industry_content_div').click(function(){
        ...
        $.ajax({
          url: "http://52.66.188.103/industry/save",
          method:'POST',
          headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
          dataType: 'json',
          data: {
          ...
          success:function(data) { 
            $("#msg_industry").html(data.message).show();
            
            setTimeout(function() {
              $("#msg_industry").fadeOut("slow").html('');
            }, 2500);
            if(data.status == "success") {
                setTimeout(function() {
                  location.reload();
