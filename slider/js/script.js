...
allCards.forEach(function (el) {
  ...
  hammertime.on('pan', function (event) {
    ...
    sliderContainer.classList.toggle('slider_love', event.deltaX > 0);
    sliderContainer.classList.toggle('slider_nope', event.deltaX < 0);
  ...
  hammertime.on('panend', function (event) {
    ...
    sliderContainer.classList.remove('slider_love');
    sliderContainer.classList.remove('slider_nope');
